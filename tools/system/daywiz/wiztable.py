...
WIZTABLE_LINES=[
	...
	[ '20091115180507.1', 4, 'milestones', 0, 'checkbox', 6, 9, 'Review progress on current <a href="/cgi-bin/nodeboard-cgi.py?D=threads&T=true" target="_blank"><b>Threads</b></a> and their <a href="/cgi-bin/fzgraphhtml-cgi.py?subtrees=threads" target="_blank">Scheduling</a>. Ensure there are Nodes to complete upcoming <a href="/cgi-bin/nodeboard-cgi.py?n=20101230042609.1" target="_blank"><b>Milestones</b></a>.', '' ],
	[ '20091115180507.1', 4, 'decisions', 0, 'checkbox', 6, 9, 'Identify <a href="/cgi-bin/fzgraphhtml-cgi.py?subtrees=challenges_open" target="_blank"><b>Challenges and Decisions in the Schedule</b></a>, add to <a href="/cgi-bin/fzgraphhtml-cgi.py?srclist=challenges_open&sort_by=targetdate" target="_blank">NNL</a> as needed.', '' ],
