...
WIZTABLE_LINES=[
	...
	[ '20091115180507.1', 4, 'milestones', 0, 'checkbox', 6, 9, 'Review progress on <a class="nnl" href="/cgi-bin/nodeboard-cgi.py?D=week_main_goals&T=true&u=204512311159&r=100&U=true&N=7" target="_blank">Weekly Goals</a> and current <a href="/cgi-bin/nodeboard-cgi.py?D=threads&T=true" target="_blank"><b>Threads</b></a> and their Scheduling [<a href="/cgi-bin/fzgraphhtml-cgi.py?subtrees=week_main_goals" target="_blank">Weekly</a>, <a href="/cgi-bin/fzgraphhtml-cgi.py?subtrees=threads" target="_blank">Threads</a>]. Ensure there are Nodes to complete upcoming <a href="/cgi-bin/nodeboard-cgi.py?n=20101230042609.1" target="_blank"><b>Milestones</b></a>.', '' ],
    ...
    [ '20091115180507.1', 2, 'checkboxes', 0, 'checkbox', 6, 9, 'Review and potentially convert recent open <button type="button" class="button button1" onclick="window.open(\'/cgi-bin/checkboxes.py?weeksinterval=24#END\',\'_blank\');">checkboxes</button> in the Log.', '' ],
    [ '20091115180507.1', 2, 'variable', 0, 'checkbox', 6, 9, 'Auto-update Variable Nodes. Possibly update <button type="button" class="button button1" onclick="window.open(\'/cgi-bin/fzgraphsearch-cgi.py?completion_lower=0.0&completion_upper=0.99&tdprop_lower=unspecified&tdprop_upper=unspecified&hours_lower=0.1&hours_upper=1000.0&btf=WORK&btf_nnl=threads&draggable=on\',\'_blank\')">WORK UTD order</button> first.', '' ],
    ...
    [ '20200601093905.1', -3, 'nicotine', 0, 'number', 21, 24, 'Nicotine consumed (mg). (Target: up to 16 mg.)', '' ],
    [ '20200601093905.1', -3, 'caffeine', 0, 'number', 21, 24, 'Caffeine consumed (cups). (Target: up to 6 cups.)', '' ],
	...
	[ '20200601093905.1', 45, 'reviewscore', 0, 'number', 22, 24, '<button type="button" class="button button1" onclick="window.open(\'/cgi-bin/fzloghtml-cgi.py?review=true&reviewdate=@Ymd@\',\'_blank\');">Day review score</button>.', '' ],
]
