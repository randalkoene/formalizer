...
WIZTABLE_LINES=[
	...
	[ '20091115180507.1', 4, 'milestones', 0, 'checkbox', 6, 9, 'Review progress on current <a href="/cgi-bin/nodeboard-cgi.py?D=threads&I=true&T=true" target="_blank"><b>Threads</b></a> (<a href="/cgi-bin/fzgraphhtml-cgi.py?subtrees=threads" target="_blank">in Schedule</a>) and ensure there are Nodes to complete upcoming <a href="/cgi-bin/nodeboard-cgi.py?n=20101230042609.1" target="_blank"><b>Milestones</b></a> (<a href="/cgi-bin/nodeboard-cgi.py?f=main2023" target="_blank">Active Main Categories</a>, <a href="/cgi-bin/nodeboard-cgi.py?n=20101230042609.1&F=%5B" target="_blank">Milestone Categories</a>, mapped to Milestones, Dependencies, Roadmap Path, Values and Urgency).', '' ],
	[ '20091115180507.1', 4, 'decisions', 0, 'checkbox', 6, 9, 'Identify <a href="/cgi-bin/fzgraphhtml-cgi.py?subtrees=challenges_open" target="_blank"><b>Challenges and Decisions in the Schedule</b></a>, tag as such, add to <a href="/cgi-bin/fzgraphhtml-cgi.py?srclist=challenges_open&sort_by=targetdate" target="_blank">NNL</a>. <a href="https://trello.com/b/mnu1VKIn" target="_blank">Known Challenges and Decisions</a> must be represented by at least one Node.', '' ],
