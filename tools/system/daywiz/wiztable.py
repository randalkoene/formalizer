...
WIZTABLE_LINES=[
	...
	[ '20091115180507.1', 4, 'milestones', 0, 'checkbox', 6, 9, 'Review upcoming Milestones (<a href="/cgi-bin/nodeboard-cgi.py?n=20101230042609.1" target="_blank">Milestones Kanban</a>, <a href="https://trello.com/b/tlgXjZBm" target="_blank">Milestone Tracks</a>, <a href="https://trello.com/b/t2RmUmlN" target="_blank">Milestones Trello</a>, mapped to Milestones, Dependencies, Roadmap Path, Values and Urgency.) Ensure there are Nodes to complete upcoming Milestones. Also, review progress on current main Nodes side-by-side (in <a href="/cgi-bin/fzgraphhtml-cgi.py?subtrees=threads" target="_blank">Schedule</a>, in <a href="/cgi-bin/nodeboard-cgi.py?D=threads&I=true&T=true" target="_blank">Kanban</a>).', '' ],
