...
WIZTABLE_LINES=[
	...
	[ '20091115180507.1', 4, 'milestones', 0, 'checkbox', 6, 9, 'Review progress on <a class="nnl" href="/cgi-bin/nodeboard-cgi.py?D=week_main_goals&T=true&u=204512311159&r=100&U=true" target="_blank">Weekly Goals</a> and current <a href="/cgi-bin/nodeboard-cgi.py?D=threads&T=true" target="_blank"><b>Threads</b></a> and their <a href="/cgi-bin/fzgraphhtml-cgi.py?subtrees=threads" target="_blank">Scheduling</a>. Ensure there are Nodes to complete upcoming <a href="/cgi-bin/nodeboard-cgi.py?n=20101230042609.1" target="_blank"><b>Milestones</b></a>.', '' ],
