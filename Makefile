...
EXECUTABLES += $(COREPATH)/fzbackup/database-from-github.py
...
EXECUTABLES += $(TOOLSPATH)/interface/indicators/indicators.py
...
EXECUTABLES += $(TOOLSPATH)/misc/user/team_subgroup.py
EXECUTABLES += $(TOOLSPATH)/misc/user/team_activities.py
EXECUTABLES += $(TOOLSPATH)/misc/user/team_clusters.py
...
EXECUTABLES += $(TOOLSPATH)/system/daywiz/email-info.py
EXECUTABLES += $(TOOLSPATH)/system/daywiz/calendar-info.py
EXECUTABLES += $(TOOLSPATH)/system/daywiz/daywiz-autodata.py
...
EXECUTABLES += $(TOOLSPATH)/system/metrics/dayreview/today_btf.py
...
SYMBIN += $(TOOLSPATH)/interface/indicators/indicators.py
...
CGIEXE += $(COREPATH)/fzgraph/subhierarchy.py
...
CGIEXE += $(TOOLSPATH)/misc/user/team_subgroup.py
CGIEXE += $(TOOLSPATH)/misc/user/team_activities.py
GIEXE += $(TOOLSPATH)/misc/user/team_clusters.py
...
CGIEXE += $(TOOLSPATH)/system/daywiz/daywiz-autodata-cgi.py
CGIEXE += $(TOOLSPATH)/system/daywiz/email-info-cgi.py
...
CGIEXE += $(TOOLSPATH)/system/metrics/dayreview/today_btf.py
